...
examples/ace/logging/logrecord.pb.cc: /root/muduo/muduo/examples/ace/logging/logrecord.proto
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/muduo/build/release-cpp11/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating logrecord.pb.cc, logrecord.pb.h"
	cd /root/muduo/build/release-cpp11/examples/ace/logging && protoc --cpp_out . /root/muduo/muduo/examples/ace/logging/logrecord.proto -I/root/muduo/muduo/examples/ace/logging
...
examples/ace/logging/CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.o: examples/ace/logging/logrecord.pb.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/muduo/build/release-cpp11/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object examples/ace/logging/CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.o"
	cd /root/muduo/build/release-cpp11/examples/ace/logging && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -Wno-conversion -Wno-shadow -o CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.o -c /root/muduo/build/release-cpp11/examples/ace/logging/logrecord.pb.cc
...
examples/ace/logging/CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.i: cmake_force
	...
	cd /root/muduo/build/release-cpp11/examples/ace/logging && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -Wno-conversion -Wno-shadow -E /root/muduo/build/release-cpp11/examples/ace/logging/logrecord.pb.cc > CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.i
...
examples/ace/logging/CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.s: cmake_force
	...
	cd /root/muduo/build/release-cpp11/examples/ace/logging && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -Wno-conversion -Wno-shadow -S /root/muduo/build/release-cpp11/examples/ace/logging/logrecord.pb.cc -o CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.s
...
lib/libace_logging_proto.a: examples/ace/logging/CMakeFiles/ace_logging_proto.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/muduo/build/release-cpp11/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX static library ../../../lib/libace_logging_proto.a"
	cd /root/muduo/build/release-cpp11/examples/ace/logging && $(CMAKE_COMMAND) -P CMakeFiles/ace_logging_proto.dir/cmake_clean_target.cmake
	cd /root/muduo/build/release-cpp11/examples/ace/logging && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/ace_logging_proto.dir/link.txt --verbose=$(VERBOSE)
...
examples/ace/logging/CMakeFiles/ace_logging_proto.dir/clean:
	cd /root/muduo/build/release-cpp11/examples/ace/logging && $(CMAKE_COMMAND) -P CMakeFiles/ace_logging_proto.dir/cmake_clean.cmake
